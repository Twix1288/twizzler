...
pub fn is_readable_stdin() -> bool {
    ...
    !({ #[cfg(not(target_os = "twizzler"))] { std::io::stdin().is_terminal() } #[cfg(target_os = "twizzler")] { false } }) && imp()
}
...
pub fn is_tty_stdin() -> bool {
    use std::io::IsTerminal;
    ({ #[cfg(not(target_os = "twizzler"))] { std::io::stdin().is_terminal() } #[cfg(target_os = "twizzler")] { false } })
}
...
pub fn is_tty_stdout() -> bool {
    use std::io::IsTerminal;
    ({ #[cfg(not(target_os = "twizzler"))] { std::io::stdout().is_terminal() } #[cfg(target_os = "twizzler")] { false } })
}
...
pub fn is_tty_stderr() -> bool {
    use std::io::IsTerminal;
    ({ #[cfg(not(target_os = "twizzler"))] { std::io::stderr().is_terminal() } #[cfg(target_os = "twizzler")] { false } })
}
